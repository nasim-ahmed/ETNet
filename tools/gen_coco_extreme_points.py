...
if __name__ == '__main__':
  for split in SPLITS:
    ...
    cats_all = data['categories']
    for i, cat in enumerate(cats_all):
      cats_all[i]['extreme_points'] = np.array(['top', 'left', 'bottom', 'right']).tolist()
    ...
    for i, ann in enumerate(anns_all):
      ...
      anns_all[i]['extreme_points'] = extreme_points.copy().flatten().tolist()
